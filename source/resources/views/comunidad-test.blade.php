...
<html lang="es">
  <head>
    ...
    <link href="img/logo.png" rel="icon"><!--[if lte IE 9]>
      <script src="js/vendor/selectivizr/selectivizr.js"></script>
      <script src="js/vendor/html5shiv/dist/html5shiv.js"></script><![endif]-->
  </head>
  <body>
    ...
    <div id="wrapper">
      <div id="section-1__comunity">
        <section>
          <h2>Únete a la comunidad de repartidoressdgsdgds</h2>
