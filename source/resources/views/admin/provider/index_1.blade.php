...
<div class="container-page">@if(session()->has('messageSuccess'))
  ...
  <div class="box_center">
    ...
    <div class="content_table">
      ...
      <hr/>
      <table id="category" data-url="/admpanel/provider/list" data-cols="name_provider,reason_social,phone,flagactive,picture_face,email,website,name_type,action" class="js-datatable">
        <thead>
          <tr>
