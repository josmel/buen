...
<div class="container-page">@if(session()->has('messageSuccess'))
  ...
  <div class="box_center">
    ...
    <div class="content_table">
      ...
      <hr/>
      <table id="category" data-url="/admpanel/publication-complaints/list" data-cols="description,name_provider,total,name_type,name_category,picture_publication,flagactive,comentarios,likes,action" class="js-datatable">
        <thead>
          <tr>
            <td class="td_first">Descripcion</td>
            <td>Proveedor</td>
            <td>Total Denuncias</td>
            <td>Tipo</td>
            <td>categoría</td>
            <td>Imagen</td>
            <td>Estado</td>
